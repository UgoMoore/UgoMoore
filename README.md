...
Lightweight, security-focused Kubernetes (K3s) cluster automated with Terraform.
This project demonstrates the deployment of a hardened single-node K3s cluster on AWS, featuring bastion-based access through HAProxy, automated provisioning, and secure kubeconfig handling. Built to showcase Kubernetes fundamentals, Infrastructure as Code, and secure access patterns suitable for edge, lab, and learning environments.
...
### **5. Vulnerability Management Lab (Qualys & OpenVAS)**  
Hands-on labs for cloud-based vulnerability scanning, reporting, remediation cycles, and compliance workflows.  
👉 <a href="https://github.com/UgoMoore/vulnerability-management-labs" target="_blank">View Project</a>

---

### **6. GRC Labs — Policies, Risk Mapping, Audit Docs**  
...
👉 <a href="https://github.com/UgoMoore/grc-labs" target="_blank">View Project</a>

---

### **7. Python Automation Labs**  
...
👉 <a href="https://github.com/UgoMoore/python-automation-labs" target="_blank">View Project</a>
...
<ul>
  ...
  <li><a href="https://www.credly.com/badges/1674b4f1-a0bf-4854-82eb-2a720336f06c" target="_blank"><b>Cisco – Computer Hardware Basics</b></a>  
